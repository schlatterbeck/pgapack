...
methods the evaluation values are never translated):
...
Note that the \verb+PGA_FITNESS_RAW+ is subject to overflows if you have
...
For such ill-conditioned problems you should use one of the ranking
variants \verb+PGA_FITNESS_NORMAL+ or \verb+PGA_FITNESS_RANKING+.
